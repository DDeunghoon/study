...
//	}
    ...
    public void contactAddition(String inputName, String inputNumber) {
        contacts.add(new Contact(inputName, inputNumber));

    }

    public void contactDelete(int operatorChoice) {
        for (int i = 0; i < contacts.size(); i++) {
            if ((operatorChoice - 1) == i) {
